...
public class Selling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tbMedicine.setForeground(new java.awt.Color(0, 0, 50));

        btnAddBill.setBackground(new java.awt.Color(0, 0, 50));
        ...
        btnPrintBill.setBackground(new java.awt.Color(0, 0, 50));
        ...
        tbQty.setForeground(new java.awt.Color(0, 0, 50));
    ...
    private void btnAddBillMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddBillMouseClicked
        ...
        else
        {
           ...
           if (i == 1) 
           {
               taBill.setText(taBill.getText()+"                 ******************************* J & A's  *******************************\n\n  "
